# bun-live-text-to-speech

Bun demo app for Deepgram Live Text-to-Speech.
...
| `DEEPGRAM_BASE_URL` | No | production endpoint | WebSocket endpoint override for non-production TTS environments, such as `wss://api.staging.deepgram.com` |
...
```
feat(bun-live-text-to-speech): add diarization support
fix(bun-live-text-to-speech): resolve WebSocket close handling
refactor(bun-live-text-to-speech): simplify session endpoint
